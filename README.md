...
### 사용자 기능
- 🔐 **회원가입/로그인** — 전화번호 + 비밀번호 인증 (Supabase Auth)
...
│   │   └── shop.tsx              #   샵
│   ├── (admin)/                  # 관리자 전용 화면 (10개 화면)
│   │   ├── bookings.tsx          #   예약 관리
│   │   ├── demo-bookings.tsx     #   시타 예약 관리
│   │   ├── demo-rackets.tsx      #   시타 라켓 관리
│   │   ├── strings.tsx           #   스트링 카탈로그 관리
│   │   ├── schedule.tsx          #   영업시간/휴무일
│   │   ├── slots.tsx             #   예약 슬롯 관리
│   │   ├── users.tsx             #   사용자 제재
│   │   ├── manage-admins.tsx     #   관리자 권한 관리
│   │   └── notifications.tsx     #   관리자 알림센터
...
│   │   └── useAdminPermissionGuard.ts  # 관리자 권한 가드
...
> ⚠️ **CRITICAL**: Supabase 실제 DB에 마이그레이션(001~018)이 미적용 상태입니다. 
