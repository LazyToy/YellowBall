    ...
    <section className="px-5 pt-2 pb-5">
      ...
      {canBook ? (
        <div className="mt-4 rounded-2xl bg-primary text-primary-foreground p-4 flex items-center justify-between gap-3 overflow-hidden relative">
          <div className="absolute -right-6 -bottom-8 size-32 rounded-full bg-yellow-400/20 blur-2xl pointer-events-none" />
          ...
          <button className="relative shrink-0 size-11 rounded-full bg-yellow-400 text-[#2b2b2b] grid place-items-center hover:scale-105 transition-transform">
