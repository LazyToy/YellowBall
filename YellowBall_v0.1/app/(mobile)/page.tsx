  ...
  return (
    <>
      ...
      <div className="px-5 pt-4 pb-6">
        <p className="text-center text-[11px] text-muted-foreground">RallyHub · 서울 성수점</p>
        <p className="text-center text-[10px] text-muted-foreground/70 mt-0.5">© 2026 RallyHub Korea</p>
      </div>
    </>
  )
}
